...
public class Priest extends Entity {
    ...
    private void loadImages() {
        idle = new ImageIcon("src/images/priest/Priest_idle.png");
        down = new ImageIcon("src/images/priest/priest_down.gif");
        left = new ImageIcon("src/images/priest/priest_left.gif");
        right = new ImageIcon("src/images/priest/priest_right.gif");
        up = new ImageIcon("src/images/priest/priest_up.gif");
        atackR = new ImageIcon("src/images/priest/priest_right.gif");
        atackD = new ImageIcon("src/images/priest/priest_down.gif");
        atackU = new ImageIcon("src/images/priest/priest_up.gif");
        atackL = new ImageIcon("src/images/priest/priest_left.gif");
        effectU = new ImageIcon("src/images/priest/atackEffect_up.gif");
        effectD = new ImageIcon("src/images/priest/atackEffect_down.gif");
        effectL = new ImageIcon("src/images/priest/atackEffect_left.gif");
        effectR = new ImageIcon("src/images/priest/atackEffect_right.gif");
        explosion = new ImageIcon("src/images/priest/atackEffect_exp.gif");


        die = new ImageIcon("src/images/priest/priest_die.gif");
    }
