...
public class Map {
    ...
    private void setItemSpawns() {
        ...
        level1SetItemSpawns = new int[][]{
                {13, 30}, {39, 30}, {3, 25}, {50, 15}, {9, 20}, {25, 19},
                {2, 23}, {46, 26}, {29, 22}, {56, 15}, {46, 19}, {24, 22}, {24, 28}, {55, 12},
                {5, 14}, {27, 20}, {44, 15}, {27, 29}, {48, 18},{12, 25},{14, 25},{16, 25},{18, 25},{20, 25},{22, 25},{24, 25},{26, 25},{28, 25},{30, 25},{32, 25},{34, 25},{36, 25},
        };
    ...
    private void setMonsterContainersPositions() {
        ...
        level1MC = new int[][]{
                {18, 5}, {18, 6},{18, 7}, {51, 5}, {51, 6},{51, 7},{41, 24}, {42, 24}, {43, 24}, {31, 19}, {32, 19}
        };
        level2MC = new int[][]{};
    }
    ...
    private void setWallPositions() {
        ...
        level1Walls = new int[][]{
                ...
                {44, 11}, {44, 12}, {44, 13}, {44, 14}, {44, 15}, {44, 16}, {44, 17}, {44, 18},{44, 29},{44, 30},{44, 31},{44, 32},{44, 33},
                {51, 3}, {51, 4}, {51, 8}, {51, 9}, {51, 11}, {51, 12}, {51, 13}, {51, 14},
                {38, 25},{38, 26},{38, 27},{38, 28},
                {12, 28},{13, 28},{14, 28},{15, 28},{16, 28},{17, 28},{18, 28}, {19, 28}, {20, 28}, {21, 28}, {22, 28}, {23, 28}, {24, 28}, {25, 28}, {26, 28},{27, 28},{28, 28},{29, 28},{30, 28},{31, 28},{32, 28},{33, 28},{34, 28},{35, 28},{37, 28},{36, 28},
